...
public class LogsRecord {
	...
	public static enum Type {
		...
		INFO(java.util.logging.Level.INFO), WARNING(
				java.util.logging.Level.WARNING), SEVERE(
				java.util.logging.Level.SEVERE), CONFIG(
				java.util.logging.Level.CONFIG), FINE(
				java.util.logging.Level.FINE), FINES(
				java.util.logging.Level.FINEST), FINER(
				java.util.logging.Level.FINER), ALL(java.util.logging.Level.ALL);
	...
	public static LogsRecord valueOf(java.util.logging.LogRecord logRecord) {
		return new LogsRecord(logRecord.getMessage(), logRecord.getMillis(),
				Type.valueOf(logRecord.getLevel()));
	}
}
